  ...
  <div class="login-container">
    ...
    >
      ...
      <el-form-item style="overflow: hidden">
        <div class="verification-code-inner-container">
          <div class="left">
            <span class="svg-container">
          ...
          <div class="right" @click="fetchVerificationCode">
            <img :src="capchaUrl" alt="" class="capcha-image" />
          </div>
        </div>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async fetchVerificationCode() {
      ...
      this.capchaUrl = res.data.captchaImage;
    },
...
.login-container {
  ...
  .verification-code-inner-container {
    width: 100%;
    display: flex;
    flex-direction: row;
    overflow: hidden;
  ...
  .verification-code-inner-container .left {
    flex: 7;
  }

  .verification-code-inner-container .right {
    flex: 5;
    display: flex;
  }
}
